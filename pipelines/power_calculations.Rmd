...
```{r higheffects1,echo=FALSE,results='hide',fig.cap="High within variance (sigma=1), peak effect size is 0.25"}
...
plot_ci_results(list("S:tp=1"=ps1,"S:tp=2"=ps2,"P:q"=ps3),cex=1.3)
```


```{r higheffects2,echo=FALSE,results='hide',fig.cap="Medium within variance (sigma=0.5), peak effect size is 0.25"}
sigma_within = 0.5
effect_size = 0.25
d = simulate_data(n_t,sigma_between,sigma_within ,effects_vec,n_subjects,effect_size)
ps1 = get_simple_power_plot(d,effects_vec,effect_size,max_n=700,nsim=nsim,alpha=0.001,tp=2)
...
```{r loweffects1,echo=FALSE,results='hide',fig.cap="High within variance (sigma=1), peak effect size is 0.1"}
sigma_between = 1 # random effect standard deviation
n_subjects = 100
sigma_within = 1
effect_size = 0.1
...
```{r loweffects2,echo=FALSE,results='hide',fig.cap="Medium within variance (sigma=0.5), peak effect size is 0.1"}
sigma_within = 0.5
effect_size = 0.1
d = simulate_data(n_t,sigma_between,sigma_within ,effects_vec,n_subjects,effect_size)
ps1 = get_simple_power_plot(d,effects_vec,effect_size,max_n=700,nsim=nsim,alpha=0.001,tp=2)
